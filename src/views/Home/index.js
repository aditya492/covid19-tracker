...
class Home extends Component {
  ...
  render() {
    ...
    if (!reduxData.error) {
      return (
        <>
          <h1 className="sta891MainH1">
            {" "}
            <GoAlert /> Corona Outbreak!!! <GoAlert />
          </h1>
          <span className="sta891MainSpan sta891MainH1 ">
            Let's Check Data!!
          </span>
          <Sidebar />
          ...
          <StateSearchBar />
          <div className="sta891CurrentDate">
            <FcCalendar style={{ fontSize: "25px" }} />
          ...
          <div className="sta891color_State_body">
            <li className="sta891Table_Header_ ">
              <div
                ...
                onClick={() => this.onHeaderClick("states")}
              >
                States/UT{" "}
              ...
              <div
                ...
                onClick={() => this.onHeaderClick("confirm")}
              >
                Confirmed{" "}
              ...
              <div
                ...
                onClick={() => this.onHeaderClick("tested")}
              >
                Tested{" "}
              ...
              <div
                ...
                onClick={() => this.onHeaderClick("recover")}
              >
                Recovered{" "}
              ...
              <div
                ...
                onClick={() => this.onHeaderClick("deceased")}
              >
                Deceased{" "}
              ...
              <div
                className="sta891Col sta891Col-5"
                style={
                  convert === "vaccinated"
                    ? { cursor: "pointer", color: "green" }
                    : { cursor: "pointer", color: "red" }
                }
                onClick={() => this.onHeaderClick("vaccinated")}
              >
                Vaccinated{" "}
                {"vaccinated" === convert && colorconvert ? (
                  <BsFillCaretUpFill color="green" />
                ) : (
                  <BsFillCaretDownFill color="red" />
                )}
      ...
      <>
        {this.props.covidData.loading ? (
          ...
          reduxData.map((reuseStatedata, i) => {
            return (
              <Link
                to={"state/" + reuseStatedata.id}
                style={{ textDecoration: "none" }}
              >
                <ul>
                  <li
                    className="sta891Statedata_table_row  link dim black b shadow-5"
                    style={{ cursor: "pointer" }}
                  >
                    <div className="sta891Col   sta891Col-0">
                      {State_List[reuseStatedata.id]}
                    </div>

                    <div className="sta891Col   sta891Col-1">
                      {isNaN(reuseStatedata.confirmed) ? (
                        "--"
                      ) : (
                        <NumberFormat
                          value={reuseStatedata.confirmed}
                          displayType={"text"}
                    ...
                    <div className="sta891Col   sta891Col-2">
                      {isNaN(reuseStatedata.tested) ? (
                        "--"
                      ) : (
                        <NumberFormat
                          value={reuseStatedata.tested}
                          displayType={"text"}
                          thousandSeparator={true}
                        />
                      )}
                    ...
                    <div className="sta891Col   sta891Col-3">
                      {isNaN(reuseStatedata.recovered) ? (
                        "--"
                      ) : (
                        <NumberFormat
                          value={reuseStatedata.recovered}
                          displayType={"text"}
                          thousandSeparator={true}
                        />
                      )}
                    ...
                    <div className="sta891Col   sta891Col-4">
                      {isNaN(reuseStatedata.deceased) ? (
                        "--"
                      ) : (
                        <NumberFormat
                          value={reuseStatedata.deceased}
                          displayType={"text"}
                          thousandSeparator={true}
                        />
                      )}
                    ...
                    <div className="sta891Col   sta891Col-5">
                      {isNaN(reuseStatedata.vaccinated) ? (
                        "--"
                      ) : (
                        <NumberFormat
                          value={reuseStatedata.vaccinated}
                          displayType={"text"}
                          thousandSeparator={true}
                        />
                      )}
...
const mapDispatchToProps = (dispatch) => {
  return {
    sortconf: (final, sortBy, dataObject, isAsc) =>
      dispatch(sortAsc(final, sortBy, dataObject, isAsc)),
