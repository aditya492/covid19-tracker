	...
	render(){
		...
		return(
			...
			<div className="main">
             ...
             <div className="c11card cardsprimary1 grow">
             ...
             <div className="c11card cardsprimary2 grow">
             ...
             <div className="c11card cardsprimary3 grow">
             ...
             <div className="c11card cardsprimary4 grow">
            ...
            <div className="c11card cardsprimary5 grow">
